...
Default493Freq = 607.42598
Default650Freq = 461.31206
FreqSetTime = 5
CoolSweepsNum = 2

Filepath = r"Z:\Lab Data\Sessions\2021\2021_02\2021_02_08\FreqScan_02"
filename = "PMTCount_Ba138"

if not os.path.exists(os.path.abspath(Filepath)):
    os.mkdir(os.path.abspath(Filepath))

Freq493Array = np.arange(607.42572,607.42620,0.00002)
Freq650Array = np.arange(461.31153,461.31253,0.00002)
